...
import { ArrowLeft, Settings2, Mic, Database as DatabaseIcon, SparkleIcon, FlaskConical, MessageSquare } from 'lucide-react';
...
const TABS = [
  ...
  { value: 'summaryPrompts', label: 'Summary Prompts', icon: MessageSquare },
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto p-8 pt-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="summaryPrompts" className="mt-6">
